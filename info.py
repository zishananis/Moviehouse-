...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002831016087'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/hfdfhhffd')
...
request_channel = environ.get('REQUEST_CHANNEL', '-1002453978699')
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002453978699'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/filmsexpert2') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
...
#---------------------------------------------------------------
#---------------------------------------------------------------
START_IMG = (environ.get('START_IMG', 'https://graph.org/file/c15bd7ae81bf2a2b6285c-3324d1505475e60ee4.jpg')).split()
FORCESUB_IMG = environ.get('FORCESUB_IMG', 'https://i.ibb.co/ZNC1Hnb/ad3f2c88a8f2.jpg')
REFER_PICS = (environ.get("REFER_PICS", "https://envs.sh/PSI.jpg")).split() 
PAYPICS = (environ.get('PAYPICS', 'https://graph.org/file/522c20bdff3217275c905-98cdf912f3654b568b.jpg')).split()
